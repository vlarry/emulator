...
public:
    ...
    void setupUi(QWidget *QKeyboard)
    {
        ...
        key_right->setMinimumSize(QSize(48, 48));
        key_right->setMaximumSize(QSize(48, 48));
        QFont font;
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/images/resource/images/arrow_right.png"), QSize(), QIcon::Normal, QIcon::Off);
        key_right->setIcon(icon);
        ...
        key_8->setMinimumSize(QSize(48, 48));
        key_8->setMaximumSize(QSize(48, 48));
        key_8->setFont(font);
        ...
        key_ok->setMinimumSize(QSize(48, 48));
        key_ok->setMaximumSize(QSize(48, 48));
        key_ok->setFont(font);
        ...
        key_left->setMinimumSize(QSize(48, 48));
        key_left->setMaximumSize(QSize(48, 48));
        key_left->setFont(font);
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/images/resource/images/arrow_left.png"), QSize(), QIcon::Normal, QIcon::Off);
        key_left->setIcon(icon1);
        ...
        key_9->setMinimumSize(QSize(48, 48));
        key_9->setMaximumSize(QSize(48, 48));
        key_9->setFont(font);
        ...
        key_0->setMinimumSize(QSize(48, 48));
        key_0->setMaximumSize(QSize(48, 48));
        key_0->setFont(font);
        ...
        key_esc->setMinimumSize(QSize(48, 48));
        key_esc->setMaximumSize(QSize(48, 48));
        ...
        key_6->setMinimumSize(QSize(48, 48));
        key_6->setMaximumSize(QSize(48, 48));
        key_6->setFont(font);
        ...
        key_point->setMinimumSize(QSize(48, 48));
        key_point->setMaximumSize(QSize(48, 48));
        ...
        key_4->setMinimumSize(QSize(48, 48));
        key_4->setMaximumSize(QSize(48, 48));
        key_4->setFont(font);
        ...
        key_5->setMinimumSize(QSize(48, 48));
        key_5->setMaximumSize(QSize(48, 48));
        key_5->setFont(font);
        ...
        key_7->setMinimumSize(QSize(48, 48));
        key_7->setMaximumSize(QSize(48, 48));
        key_7->setFont(font);
        ...
        key_2->setMinimumSize(QSize(48, 48));
        key_2->setMaximumSize(QSize(48, 48));
        key_2->setFont(font);
        ...
        key_off->setMinimumSize(QSize(48, 48));
        key_off->setMaximumSize(QSize(48, 48));
        key_off->setFont(font);
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/images/resource/images/key_off.png"), QSize(), QIcon::Normal, QIcon::Off);
        key_off->setIcon(icon2);
        ...
        key_3->setMinimumSize(QSize(48, 48));
        key_3->setMaximumSize(QSize(48, 48));
        key_3->setFont(font);
        ...
        key_up->setMinimumSize(QSize(48, 48));
        key_up->setMaximumSize(QSize(48, 48));
        key_up->setFont(font);
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/images/resource/images/arrow_up.png"), QSize(), QIcon::Normal, QIcon::Off);
        key_up->setIcon(icon3);
        ...
        key_1->setMinimumSize(QSize(48, 48));
        key_1->setMaximumSize(QSize(48, 48));
        key_1->setFont(font);
        ...
        key_on->setMinimumSize(QSize(48, 48));
        key_on->setMaximumSize(QSize(48, 48));
        key_on->setFont(font);
        QIcon icon4;
        ...
        key_down->setMinimumSize(QSize(48, 48));
        key_down->setMaximumSize(QSize(48, 48));
        key_down->setFont(font);
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/images/resource/images/arrow_down.png"), QSize(), QIcon::Normal, QIcon::Off);
        key_down->setIcon(icon5);
        ...
        key_reset->setMinimumSize(QSize(48, 48));
        key_reset->setMaximumSize(QSize(48, 48));
